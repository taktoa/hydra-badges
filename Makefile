...
nix-shell: nix/haskell/hydra-badges.nix
...
> rm -vf dist/doc/html/$(PACKAGE_NAME)/haddock-util.js
> rm -vf dist/doc/html/$(PACKAGE_NAME)/ocean.css
> cd dist/doc/html/$(PACKAGE_NAME);                        \
>     ln -sv ../../../../misc/haddock.js  haddock-util.js; \
>     ln -sv ../../../../misc/haddock.css ocean.css
> cp -v $(JQUERY) dist/doc/html/$(PACKAGE_NAME)/jquery.js
...
nix/haskell: nix/haskell/$(PACKAGE_NAME).nix

nix/haskell/$(PACKAGE_NAME).nix: $(PACKAGE_NAME).cabal
> cd nix/haskell; cabal2nix ../.. > $(PACKAGE_NAME).nix
